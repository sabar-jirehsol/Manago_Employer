...
import 'package:manago_employer/models/EmployeeByUserId.dart';
import 'package:connectivity/connectivity.dart';
import 'package:manago_employer/utils/alert.dart';
import 'package:manago_employer/utils/connection.dart';
import 'package:http/http.dart' as http;

class EmployeeByUserIdService {
  static BuildContext? context;
  static Future<EmployeeByUserId?> getEmployeeId(
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          final jsonResponse = employeeByUserIdFromJson(response.body);
          return jsonResponse;
