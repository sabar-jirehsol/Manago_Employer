...
class CandidateDetailsService {
  ...
  static Future<CandidateDetailsModel?> getCandidateDetails(
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      try {
        ...
        print("Candidate Details :${response.body}");
        if (response.statusCode == 200) {
          final jsonResponse = candidateDetailsModelFromJson(response.body);
          print(jsonResponse);
          return jsonResponse;
