...
class JobDetailsService {
  ...
  static Future<JobDetailsModel?>jobDetailsService(
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      try {
        ...
        print("job details statuscode${response.statusCode}");
        print(response.body);
        if (response.statusCode == 200) {
          JobDetailsModel jsonResponse = jobDetailsModelFromJson(response.body);
