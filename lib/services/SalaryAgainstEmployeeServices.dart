...
class SalaryAgainstEmployeeServices {
  static BuildContext? context;
  static Future<SalaryAgainstEmployeeModel?> getSalaryAgainstEmployeeService(
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      try {
        ...
        if (response.statusCode == 200) {
          SalaryAgainstEmployeeModel jsonResponse =
              salaryAgainstEmployeeModelFromJson(response.body);
          return jsonResponse;
