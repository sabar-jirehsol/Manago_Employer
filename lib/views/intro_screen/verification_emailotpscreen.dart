...
class VerificationEmailOtpScreen extends StatefulWidget {
  ...
  VerificationEmailOtpScreen({this.email});
  @override
  _VerificationEmailOtpScreenState createState() => _VerificationEmailOtpScreenState();
}

class _VerificationEmailOtpScreenState extends StateMVC<VerificationEmailOtpScreen>
    with CodeAutoFill {
  ...
  _VerificationEmailOtpScreenState() : super(VerificationController()) {
                      ...
                      children: [
                        Center(
                          child: Pinput(
                            ...
                            // errorPinTheme: defaultPinTheme.copyBorderWith(C
                            //   border: Border.all(color: Colors.redAccent),
                            // ),
                          ),
                        ),
                        _con!.email_otp?errorText(_con!.invalid_Otp_text):const SizedBox(),
                        SizedBox(height: 30),
                        Container(
                        ...
                        flag == 0
                          ...
                          onTap: () async {
                            setState(() {
                              flag = 0;
                              _start = 60;
                              LoginServices.sendEmailOTPForForgotPassword(API.forgotPassword,widget.email!, 'employer',scaffoldKey, context);
                              // LoginServices.login(
                              //     API.login,
