...
class EmployeeProfessionalInfoData extends StatefulWidget {
  final EmployeeData? data;

  const EmployeeProfessionalInfoData({Key? key, this.data}) : super(key: key);
  @override
  _EmployeeProfessionalInfoState createState() =>
      _EmployeeProfessionalInfoState();
}

class _EmployeeProfessionalInfoState
    extends State<EmployeeProfessionalInfoData> {
