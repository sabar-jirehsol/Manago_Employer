...
class JobEducationInfoData extends StatefulWidget {
  final ApplicantsDetailsData? data;

  const JobEducationInfoData({Key? key, this.data}) : super(key: key);

  @override
  _EducationInfoState createState() => _EducationInfoState();
}

class _EducationInfoState extends State<JobEducationInfoData> {
  @override
