...
class JobJobPreferenceData extends StatefulWidget {
  final ApplicantsDetailsData? data;

  const JobJobPreferenceData({Key? key, this.data}) : super(key: key);

  @override
  _JobJobPreferenceState createState() => _JobJobPreferenceState();
}

class _JobJobPreferenceState extends State<JobJobPreferenceData> {
