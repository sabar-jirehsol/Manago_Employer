...
class ApplicantProfessionalInfoData extends StatefulWidget {
  final ApplicantsDetailsData? data;

  const ApplicantProfessionalInfoData({Key? key, this.data}) : super(key: key);
  @override
  _ProfessionalInfoState createState() => _ProfessionalInfoState();
}

class _ProfessionalInfoState extends State<ApplicantProfessionalInfoData> {
        ...
        children: [
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.data!.candidateId!.professionalInfo!.jobDetails![i].jobTitle == null
                                  ? 'No value'
          ...
          Row(
            ...
            children: [
              ...
              Value(
                  text: widget
                      .data!.candidateId!.professionalInfo!.prefferedIndustry),
            ],
          ),
          // Row(
          //   crossAxisAlignment: CrossAxisAlignment.start,
...
class EmployeeProfesstionalInfoData extends StatefulWidget {
  final EmployeeData? data;

  const EmployeeProfesstionalInfoData({Key? key, this.data}) : super(key: key);

  @override
  State<EmployeeProfesstionalInfoData> createState() =>
      _EmployeeProfesstionalInfoDataState();
}

class _EmployeeProfesstionalInfoDataState
    extends State<EmployeeProfesstionalInfoData> {
  List<String> keySkills = [
    'Flutter',
    'dart',
    'msoffice',
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Value(
                text: widget.data!.candidateId!.professionalInfo!
                            .totalExperience ==
                        null
                    ? 'No value'
                    : "${widget.data!.candidateId!.professionalInfo!.totalExperience} years",
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                for (var i = 0;
                    i <
                        widget.data!.candidateId!.professionalInfo!.jobDetails!
                            .length;
                    i++)
                  Card(
                    shape: RoundedRectangleBorder(),
